...
<style>
html, body, .stApp {{
    background-color: {COLORS_THEME["bg"]} !important;
    color: {COLORS_THEME["text"]} !important;
}}

section[data-testid="stSidebar"] {{
    background-color: {COLORS_THEME["secondary_bg"]} !important;
}}
...
.metric-card {{
    background: {COLORS_THEME["secondary_bg"]};
...
.insight-box {{
    background: {"#0F2E2A" if is_dark else "#E1F5EE"};
    color: {COLORS_THEME["text"]};
    border-left: 4px solid #1D9E75;
}}

[data-testid="stDataFrame"] {{
    background-color: {COLORS_THEME["secondary_bg"]};
}}

.footer {{
    color: {COLORS_THEME["subtext"]};
    border-top: 1px solid {COLORS_THEME["border"]};
}}
</style>
